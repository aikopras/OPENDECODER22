...
//------------------------------------------------------------------------
//
// file:      cv_data_relays4.h  -> Note that this is an include file, and not a normal header file
...
// Content         Name         CV  Access Comment
   ...
   0b00100000,  // DecType      27  R/W    Decoder Type
...
// CVs specific for the SWITCH Decoder
   0,           // SendFB	33  R/W    Decoder will send switch feedback messages via RS-Bus 
                                           // Should be 0 if decoder sends ONLY PoM feedback (Add. 128)
   0,           // AlwaysAct	34  R/W    If set, decoder will activate coil / relays for each DCC command
